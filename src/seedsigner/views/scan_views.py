...
from .view import BackStackView, ErrorView, MainMenuView, NotYetImplementedView, View, Destination
...
class ScanView(View):
    ...
    def run(self):
        ...
        self.run_screen(scan_screens.ScanScreen, instructions_text=self.instructions_text, decoder=self.decoder)
